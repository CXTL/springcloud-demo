...
public class ArithmeticUtils {
     ...
     */
    public static String add(String v1, String v2, int scale) throws IllegalAccessException {
        if (scale < 0) {
            throw new IllegalAccessException("The scale must be a positive integer or zero");
        }
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return b1.add(b2).setScale(2, RoundingMode.HALF_UP).toString();
    }
     ...
     * @throws IllegalAccessException
     */
    public static String sub(String v1, String v2, int scale) throws IllegalAccessException {
        if (scale < 0) {
            throw new IllegalAccessException("The scale must be a positive integer or zero");
        }
        BigDecimal b1 = new BigDecimal(v1);
    ...
    public static String remainder(String v1, String v2, int scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return b1.remainder(b2).setScale(2, RoundingMode.HALF_UP).toString();
    }
    ...
    public static BigDecimal remainder(BigDecimal v1, BigDecimal v2, int scale) {
        ...
        return v1.remainder(v2).setScale(2, RoundingMode.HALF_UP);
    }
