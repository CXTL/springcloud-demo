 ...
 * @Description TODO
 * @createTime 2020年05月17日 18:28:00
 */
...
//        String projectPath = CodeGenerator.class.getResource("/").getPath();
        String projectPath = "/home/xt/data/workspace/xt-workspace/baby-manage-server/baby-generator";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/zc?serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8");
        ...
        pc.setParent("com.dupake.generator")
                .setMapper("dao");
