...
INSERT INTO `fin_asset` VALUES (1,'001',533.00,133.00,533.00,1,-1,1596188637948,-1,1596610503851,0,'test'),(2,'002',1220.00,100.00,1220.00,1,-1,1596189171095,-1,1596531583918,0,'test'),(3,'003',379.00,0.00,379.00,0,-1,1596516116030,-1,1596531925883,0,NULL);
...
CREATE TABLE `fin_asset_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='财务-余额记录信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fin_invest` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='财务-投资信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fin_invest` VALUES (1,'001','test',100.00,100.00,100,-1,1596192129010,-1,1596192129010,0,'100','001',NULL,NULL),(2,'002','test',167.00,144.00,1,-1,1596507595287,-1,1596507595287,0,'test','001',NULL,NULL),(3,'001','t',100.00,100.00,100,-1,1596610503816,-1,1596610503816,0,'100','334',NULL,NULL),(4,'003','test',100.00,100.00,1,-1,1596774314045,-1,1596774314045,0,'test','332',110.00,1595952000000);
...
CREATE TABLE `report_asset` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='报表-资产报表(每天统计)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-07 17:44:06
