...
(
    ...
    hidden      int          null comment '是否隐藏 0:未隐藏1:已隐藏',
    permission   varchar(32)  null comment '权限',
    type        int          null comment '类型 0:菜单权限1:资源权限',
...
(
    id          bigint auto_increment comment 'id'
        primary key,
    name        varchar(32) null comment '名称',
    is_enable       int         null comment '是否启用 0:否 1:是',
...
(
    ...
    status      int         null comment '状态 0:未激活1:已激活2:已锁定3:已注销4::账号异常',
...
(
    ...
    user_id     bigint     null comment '用户ID',
    account_code     bigint     null comment '帐套编号'
)
    comment '用户帐套关联表 ';
...
(
    ...
    account_name        varchar(32)  null comment '帐套名称',
    company_name          varchar(50)       null comment '公司名称',
    tax_number        varchar(50)          null comment '纳税识别号',
    address        varchar(100) null comment '地址',
    phone        varchar(13) null comment '电话',
    bank_account        varchar(50) null comment '开户银行',
    bank_card_number      varchar(50)          null comment '银行卡号',
    create_id   bigint       null comment '创建人',
    create_time bigint    null comment '创建时间',
    update_id   bigint       null comment '更新人',
    update_time bigint    null comment '更新时间',
...
(
    id          bigint auto_increment comment 'id'
        primary key,
    subject_code        varchar(32)  null comment '科目编号',
    subject_name         varchar(32)       null comment '科目名称',
    parent_code        varchar(32)          null comment '父科目编号',
    subject_type        int null comment '科目类型 1 资产 2负载 3权益 4成本 5其他',
    borrow_flag        int null comment '借贷方向 0:借 1:贷',
    create_id   bigint       null comment '创建人',
    create_time bigint    null comment '创建时间',
    update_id   bigint       null comment '更新人',
    update_time bigint    null comment '更新时间',
...
(
    id          bigint auto_increment comment 'id'
        primary key,
    account_code        varchar(32)  null comment '帐套信息编码',
    total_balance        decimal(11,2)  null comment '总余额',
    freeze_balance         decimal(11,2)       null comment '冻结余额',
    available_balance        decimal(11,2)          null comment '可用余额',
...
(
    ...
    pay_amount         decimal(11,2)       null comment '应付金额',
    real_receive_amount         decimal(11,2)       null comment '实收金额',
    real_pay_amount         decimal(11,2)       null comment '实付金额',
    amount         decimal(11,2)       null comment '金额',
    balance_before         decimal(11,2)       null comment '变动前余额',
    balance_after         decimal(11,2)      null comment '变动后余额',
